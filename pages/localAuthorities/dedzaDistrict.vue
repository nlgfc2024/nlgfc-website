...
const projects = [
  ...
  },
  {
    ...
    description: 'A program designed to build community resilience and provide social support to vulnerable populations in Dedza District.',
    objectives: [
...
const news = [
  {
    title: 'Dedza District Council Launches New Water Project',
    date: '2024-12-10',
          ...
          >
            <div v-if="activeTab === 'profile'" key="profile" class="content-panel">
              <div class="prose max-w-none">
                <h2 class="text-2xl font-bold text-gray-900 mb-6 pb-2 border-b border-gray-200">Dedza District Council Profile</h2>
                <div class="space-y-6">
                  <div class="bg-blue-50 p-6 rounded-lg border border-gray-200 hover:shadow-md transition-shadow duration-300">
                    <h3 class="text-lg font-semibold text-gray-900 mb-3">About Dedza District Council</h3>
