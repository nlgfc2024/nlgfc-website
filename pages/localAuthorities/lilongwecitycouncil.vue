...
const newsArticles = ref([
  ...
  {
    id: 3,
    title: 'Lilongwe City Council Unveils New Waste Management Strategy',
    ...
    content: `
      <p>Lilongwe City Council has launched an innovative waste management strategy that aims to revolutionize how the commercial capital handles solid waste. The comprehensive plan emphasizes community participation, recycling initiatives, and sustainable waste disposal methods.</p>
    ...
    date: '2025-08-10',
    author: 'Grace Phiri',
    source: 'Lilongwe City Council',
    tags: ['Waste Management', 'Lilongwe', 'Environment', 'Recycling']
  },
  {
    id: 4,
    ...
    <div class="container mx-auto px-4 py-8 flex flex-col md:flex-row gap-8 max-w-6xl">
      ...
      <div class="flex-1 min-w-0">
        <div v-show="activeTab === 'profile'" class="prose max-w-none">
            <BlocksRenderer :blocks="pages?.['lilongwe-council-profile']?.blocks || []" />
          <h2 class="text-2xl font-bold text-gray-900 mb-6 pb-2 border-b border-gray-200">
            ...
            Lilongwe District Council Profile</h2>
          <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div class="p-6 rounded-xl border emerald-700 shadow-lg hover:shadow-xl transition-shadow duration-300">
              <h3 class="text-lg font-semibold text-gray-900 mb-3 flex items-center gap-2">
                ...
                About Lilongwe District Council
