  ...
  <div class="bg-white">
    ...
    <div class="container mx-auto px-4 py-8 flex flex-col md:flex-row gap-8 max-w-6xl">
      ...
      <main class="flex-1 min-w-0">
        <!-- Global loading / error banner for page blocks -->
        ...
        <div v-else-if="PageError" class="text-center py-12 text-red-600">
          <p class="mb-3">Failed to load delivery systems content.</p>
          <button @click="$fetch" class="px-4 py-2 bg-emerald-600 text-white rounded hover:bg-emerald-700 transition">Try Again</button>
        </div>
