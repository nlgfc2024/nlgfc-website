...
<template>
  <div class="bg-white">
        ...
        <div v-for="group in projectGroups" :key="group.group">
          <div v-for="item in group.items" :key="item.id" v-show="activeTab === item.id" class="prose max-w-none">
            ...
            <div v-if="item.id === 'msr'">
              <h2 class="text-2xl font-bold text-gray-900 mb-6 pb-2 border-b border-gray-200">Malawi Social Registry</h2>
    ...
    <p class="text-gray-700 leading-relaxed">
      ...
      accesses, and shares socioeconomic and demographic data about households across the country. Its main purpose is to 
      support the implementation of social support programs by ensuring that assistance such as cash, food, or other forms of 
      help reaches those who need it most. Instead of relying on estimates
       or assumptions, the UBR provides accurate household data that programs can use to identify and assist the right people
    </p>
  </div>
            ...
            <div v-else-if="item.id === 'laifmis'">
              <div class="max-w-4xl">
                <h2 class="text-2xl font-bold text-gray-900 mb-6 pb-2 border-b border-gray-200">Local Authority Integrated Finance Management Information System</h2>
                
                <div class="bg-blue-50 p-6 rounded-lg border border-blue-200 mb-6">
    <p class="text-gray-700 leading-relaxed">
      The Local Authority Integrated Finance Management Information System (LAIFMIS) is a comprehensive digital
       platform designed to streamline financial management processes across local government authorities in Malawi. This system 
      enhances transparency, accountability, and efficiency in public financial management at the local level.
    </p>
                </div>
...
<div v-else-if="item.id === 'lapas'" class="prose max-w-none">
  <h2 class="text-2xl font-bold text-gray-900 mb-6 pb-2 border-b border-gray-200">
    Local Authority Performance Assessment (LAPAS)
  </h2>
  
  <div class="bg-blue-50 p-6 rounded-lg border border-blue-200 mb-6">
    <p class="text-gray-700 leading-relaxed">
      The Local Authority Performance Assessment System (LAPAS) is a comprehensive platform designed to evaluate and monitor the performance of local government councils in Malawi. This system provides transparent insights into local authority operations and service delivery.
    </p>
  </div>
  ...
  <div class="mt-8 space-y-6">
    <div class="bg-blue-50 p-6 rounded-lg border border-blue-200">
      ...
      <div class="text-gray-700 space-y-2 mb-4">
        <p>• Performance monitoring and evaluation tools</p>
        <p>• Transparent reporting mechanisms</p>
        <p>• Data-driven decision making support</p>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
      <div class="bg-white p-4 rounded-lg border border-gray-200 shadow-sm">
        <h4 class="text-md font-semibold text-gray-900 mb-2">For Local Authorities</h4>
        <p class="text-gray-700 text-sm">
          Access comprehensive performance data, identify areas for improvement, and track progress over time.
        </p>
      </div>
      
      <div class="bg-white p-4 rounded-lg border border-gray-200 shadow-sm">
        <h4 class="text-md font-semibold text-gray-900 mb-2">For Citizens</h4>
        <p class="text-gray-700 text-sm">
          Stay informed about your local government's performance and hold officials accountable.
        </p>
      </div>
    </div>
  </div>
