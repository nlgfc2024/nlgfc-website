...
<template>
  <div class="relative overflow-hidden rounded-xl shadow-2xl h-[500px] md:h-[600px] lg:h-[700px]">
    <!-- Slides -->
    <div 
    ...
    >
      ...
      <div class="relative h-full flex flex-col justify-end z-20">
        <div class="container mx-auto px-6 pb-16 md:pb-24 lg:px-16">
          <!-- Category and Date -->
          <div class="flex items-center mb-4 animate-fadeIn">
            ...
            <!-- <span class="ml-4 text-sm font-medium text-white/80">{{ item.date }}</span> -->
            <!-- <span class="ml-4 text-sm font-medium text-white/80">{{ item.readTime }}</span> -->
          </div>
          ...
          <div class="max-w-3xl">
            ...
            <p class="text-lg md:text-xl text-white/90 mb-8 animate-fadeIn delay-200">
              {{ item.excerpt }}
            </p>
          </div>
