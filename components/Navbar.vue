    ...
    <div class="bg-gray-900 text-white py-2 px-4">
      <div class="container mx-auto">
        <div class="flex justify-between items-center">
          <span class="text-lg font-bold hidden md:inline-block ml-30">
      ...
      <div class="flex justify-between items-center">
        ...
        <div class="flex items-start">
          <a href="/" class="flex items-center">
            ...
            <!-- Website name (hidden on mobile, visible on md screens and up) -->
          </a>
        </div>
        ...
        <nav class="hidden lg:flex items-center space-x-1">
          ...
          <div @mouseenter="toggleMegaMenu(null)" class="relative">
            <a href="/" class="flex items-center px-4 py-2 text-gray-800 hover:text-blue-700 hover:bg-blue-50 rounded-md transition font-medium">
              Home
            </a>
          </div>
          <!-- About Us Mega Menu -->
            ...
            <div v-show="activeMegaMenu === 'deliver'" class="absolute left-0 w-100 bg-white shadow-xl rounded-md py-3 z-50 border border-gray-100">
              <div class="space-y-4 p-4">
                <div class="mt-10 md:mt-0">
                  ...
                  <ul class="space-y-2">
                    <li><NuxtLink to="/deliverySystems/deliverySystems#laifmis" class="text-gray-600 hover:text-blue-600">Local Authorities Integrated Financial MIS</NuxtLink></li>
<li><NuxtLink to="/deliverySystems/deliverySystems#comsip" class="text-gray-600 hover:text-blue-600">COMSIP Integrated Management Information System</NuxtLink></li>
...
<li><NuxtLink to="/deliverySystems/deliverySystems#digital-payment-services" class="text-gray-600 hover:text-blue-600">Digital Payment Services</NuxtLink></li>
...
<li><NuxtLink to="/deliverySystems/deliverySystems#msr" class="text-gray-600 hover:text-blue-600">Malawi Social Registry MIS</NuxtLink></li>
